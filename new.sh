...
cd m*t*t
pwd
wget -O config.env https://raw.githubusercontent.com/rooted-cyber/terminal-bot/main/cmw
wget -O token.pickle https://raw.githubusercontent.com/rooted-cyber/uploading/main/tk
rin
bash star*
}
dl
